package com.hj.leetcode.kotlin.problem3463

/**
 * LeetCode page: [3463. Check If Digits Are Equal in String After Operations II](https://leetcode.com/problems/check-if-digits-are-equal-in-string-after-operations-ii/);
 */
class Solution {
    // Complexity:
