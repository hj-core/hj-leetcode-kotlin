...
class Solution {
    ...
    fun reverseBits(n: Int): Int {
        ...
        val m3 = 0x00ff_00ff // 0000_0000_1111_1111_...

        // Swap adjacent 0s and 1s
        var x = n
        x = (x ushr 1 and m0) or (x and m0 shl 1) // 01 to 10 swap
        x = (x ushr 2 and m1) or (x and m1 shl 2) // 0011 to 1100 swap
